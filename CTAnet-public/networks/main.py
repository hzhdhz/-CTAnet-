...
from .ctanet_hz import ctanet_hz
...
def build_network(net_name, ae_net=None):
    ...
    implemented_networks = ('ctanet_hz', 'mnist_LeNet', 'mnist_DGM_M2', 'mnist_DGM_M1M2',
...
def build_autoencoder(net_name):
    ...
    implemented_networks = ('ctanet_hz', 'swin_Unet_hz', 'transformer_hz', 'mnist_LeNet', 'mnist_DGM_M1M2',
