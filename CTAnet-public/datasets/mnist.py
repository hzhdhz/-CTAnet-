...
class MyMNIST(MNIST):
    ...
    def __getitem__(self, index):
        ...
        # #img, target, semi_target, index================ torch.Size([1, 28, 28]) 0 0 17828
        #
        # print('img, target, semi_target, index================', type(img),
        #       type(target), type(semi_target), type(index))
        #img, target, semi_target, index================
        # <class 'torch.Tensor'> <class 'int'> <class 'int'> <class 'int'>
